...
SELECT PatientID, Patient_Name, [NIC or Passport], Gender, Contact_No, Address, Status, Blood_Type FROM Patient WHERE (PatientID = @PatientID)";
        ...
        public virtual int Fill(HMSDataSet6.PatientDataTable dataTable) {
        ...
        public virtual HMSDataSet6.PatientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HMSDataSet6.PatientDataTable dataTable = new HMSDataSet6.PatientDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HMSDataSet6.PatientDataTable dataTable) {
